const RULES = [
  ...
  { key: "workAuthorization.authorized", patterns: ["authorized to work", "legally authorized", "work authorization"], label: "Work authorization", sensitive: true, manualOnly: true },
  { key: "workAuthorization.sponsorship", patterns: ["sponsorship", "sponsor", "visa sponsorship"], label: "Sponsorship", sensitive: true, manualOnly: true },
  { key: "preferences.relocate", patterns: ["relocate", "relocation", "willing to move"], label: "Relocation", sensitive: false, manualOnly: true },
  { key: "preferences.salary", patterns: ["desired salary", "salary expectation", "compensation"], label: "Salary expectation", sensitive: true, manualOnly: true },
